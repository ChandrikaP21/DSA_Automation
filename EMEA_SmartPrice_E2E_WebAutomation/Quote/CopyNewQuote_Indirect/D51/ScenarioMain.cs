...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CopyNewQuote_Indirect.D51.ScenarioMain
{
    public class ScenarioMain :D49.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test, string ScenarioId,int testCaseNumber, string country = null, List<string> application = null)
        {
            ...
            try
            {
                ...
                resultLog.GenerateReportInCSV(ds, retriveSmartPriceData, totalFinancialCalculation,ScenarioId,testCaseNumber,null,customerObj,null,null,true,false,quoteSummaryObject,goalDetails);
            ...
            {
                ShowStopperException exec = new ShowStopperException("Exception Occured in D51", e);
                exec.LogException();
