...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CopyNewQuote_Indirect.D56
{
    public class ScenarioMain : D49.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test,string scenarioid,int testCaseNumber, string country = null, List<string> application = null)
        {
            ...
            try
            {
                ...
                resultLog.GenerateReportInCSVIndirect(ds,retriveSmartPriceData, totalFinancialCalculation,scenarioid,testCaseNumber,"",customerObj,true,"",null,null,false,pnrapilog1,pnrapilog2);
            ...
            {
                ShowStopperException exec = new ShowStopperException("Exception Occured in D56", e);
                exec.LogException();
