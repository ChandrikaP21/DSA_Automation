...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CopyNewVersion_Direct.D32
{
    public class ScenarioMain : D17.ScenarioMain
    {
       ...
       //     Constant cs = new Constant();
            ...
            try
            {
                ...
                int index = 0;
                d16scenarioMain.VerifyStandardpartnerDiscount(resultLog, dsaObj, locator, SpPopUpObject, sp1, sp2, withOutVersionQuoteNo, odb, testCaseNumber, totalFinancialCalculation, scenarioId, test.StandardPartnerDiscountType, test.ProductIdentificationData,false,null, retriveSmartPriceData,test,true);
            ...
            {
                ShowStopperException exec = new ShowStopperException("Exception Occured in D32", e);
                exec.LogException();
