...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CopyNewVersion_Indirect.D70
{
    public class ScenarioMain : CopyNewVersion_Direct.D17.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test,string scenarioid,int testCaseNumber, string country = null, List<string> application = null)
        {
            ...
            {
                ShowStopperException exec = new ShowStopperException("Exception Occured in D70", e);
                exec.LogException();
