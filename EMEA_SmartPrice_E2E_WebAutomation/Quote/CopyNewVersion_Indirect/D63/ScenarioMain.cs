...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CopyNewVersion_Indirect.D63
{
    public class ScenarioMain : CopyNewVersion_Direct.D17.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test, string scenarioId, int testCaseNumber, string country = null, List<string> application = null)
        {
           ...
           // ScenarioMain mainScenario = new ScenarioMain(Constant.URL_Prod);
            ...
            {
                ShowStopperException exec = new ShowStopperException("Exception Occured in D63", e);
                exec.LogException();
