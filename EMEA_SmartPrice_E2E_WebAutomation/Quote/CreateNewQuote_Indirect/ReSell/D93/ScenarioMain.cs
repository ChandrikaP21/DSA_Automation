...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Indirect.ReSell.D93
{
    class ScenarioMain : StockAndSell.D78.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test,string scenarioId,int testCaseNumber, string country = null, List<string> application = null)
        {
            ...
            try
            {
                ...
                EMEA_SmartPrice_E2E_WebAutomation.Quote.CopyNewQuote_Direct.D04.ScenarioMain d04 = new CopyNewQuote_Direct.D04.ScenarioMain("",WebDriver);
            ...
            catch (Exception ex)
            {
                ...
                throw new ShowStopperException("Unexpected error occured in D93", ex);
