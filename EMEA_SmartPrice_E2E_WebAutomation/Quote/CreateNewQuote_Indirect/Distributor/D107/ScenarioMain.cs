...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Indirect.Distributor.D107
{
    public class ScenarioMain : ReSell.D91.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test, string ScenarioID,int testCaseNumber, string country = null, List<string> application = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ShowStopperException("Unexpected error occured in D107", ex);
