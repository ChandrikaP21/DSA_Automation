...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Indirect.Distributor.D116
{
    public class ScenarioMain : ReSell.D91.ScenarioMain
    {
       ...
       //     Constant cs = new Constant();
            ...
            try
            {
                ...
                LoadDSA();
                CreateQuoteRetriveAndCompareCustomerDetails(dsaObj,test,customerClass,productObject,true);
            ...
            catch (Exception ex)
            {
                ...
                throw new ShowStopperException("Unexpected error occured in D116", ex);
