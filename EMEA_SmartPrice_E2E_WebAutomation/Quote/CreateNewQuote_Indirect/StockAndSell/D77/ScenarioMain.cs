...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Indirect.StockAndSell.D77
{
    public class ScenarioMain : CopyNewQuote_Direct.D01.ScenarioMain
    {
        ...
        public void ExecuteTestCases(TestCase test, string ScenarioId,int testCaseNumber, string country = null, List<string> application = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ShowStopperException("Unexpected error occured in D77", ex);
