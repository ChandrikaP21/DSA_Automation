...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Indirect.StockAndSell.D90
{
    public class ScenarioMain : D78.ScenarioMain
    {
       ...
       //     Constant cs = new Constant();
            ...
            try
            {
                ...
                CreateQuoteRetriveAndCompareCustomerDetails(dsaObj,test,  customerClass,productObject,false,false);
            ...
            catch (Exception ex)
            {
                ...
                throw new ShowStopperException("Unexpected error occured in D90", ex);
