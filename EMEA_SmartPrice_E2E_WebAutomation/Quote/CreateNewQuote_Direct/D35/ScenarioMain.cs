...
namespace EMEA_SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Direct.D35
{
    public class ScenarioMain : D34.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test, string ScenarioId, int testCaseNumber, string country = null, List<string> application = null)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(test.ModuleId) && string.IsNullOrEmpty(test.ComponentId))//without module id and without component ID
                {
            ...
            catch (Exception ex)
            {
               // WebDriverUtils.TakeSnapShot(WebDriver);
                throw new ShowStopperException("Unexpecte Error", ex);
