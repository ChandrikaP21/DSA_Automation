...
namespace SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Direct.D48
{
    public class ScenarioMain : D34.ScenarioMain
    {
       ...
       //     Constant cs = new Constant();
            ...
            try
            {
                ...
                d16scenarioMain.VerifyStandardpartnerDiscount(resultLog, dsaObj, locator, SpPopUpObject, sp1, sp2, withOutVersionQuoteNo, odb, testCaseNumber, totalFinancialCalculation, scenarioId, test.StandardPartnerDiscountType, test.ProductIdentificationData,false,null, retriveSmartPriceDetailsList);
