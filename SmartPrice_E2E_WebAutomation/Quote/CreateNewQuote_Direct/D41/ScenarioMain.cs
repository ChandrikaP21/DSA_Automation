...
namespace SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Direct.D41
{
    public class ScenarioMain : D34.ScenarioMain
    {
        ...
        private void DecreaseQuantity(TestCase testCase, Constant constant,TotalFinancialCalculation totalFinancialCalculation,string ScenarioId,DSAPageObject dsa,ResultLogging resultLog,int testCaseNumber,List<DSAPageObject> retriveSpDetailsList)
        {
            ...
            string runId = RunId;
                ...
                RefreshGuidanceCompareAndGenerateReport(retriveSpDetailsList, totalFinancialCalculation, dsa, resultLog, ScenarioId, testCaseNumber, runId,"1", null,constant,testCase);
                ...
                RefreshGuidanceCompareAndGenerateReport(retriveSpDetailsList, totalFinancialCalculation, dsa, resultLog, ScenarioId, testCaseNumber, runId,"2", null,constant,testCase);
