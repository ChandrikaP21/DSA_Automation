                ...
                try
                {
                    ...
                    switch (scenario.ScenarioID)
                    {
                        ...
                        case "D04":
                            ...
                            Quote.CopyNewQuote_Direct.D04.ScenarioMain d04scenarioMain = new Quote.CopyNewQuote_Direct.D04.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d04scenarioMain);


                            break;
                        case "D05":
                            Quote.CopyNewQuote_Direct.D05.ScenarioMain d05scenarioMain = new Quote.CopyNewQuote_Direct.D05.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d05scenarioMain);

                            break;
                        case "D06":
                            Quote.CopyNewQuote_Direct.D06.ScenarioMain d06scenarioMain = new Quote.CopyNewQuote_Direct.D06.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d06scenarioMain);

                            break;
                        case "D07":
                            Quote.CopyNewQuote_Direct.D07.ScenarioMain d07scenarioMain = new Quote.CopyNewQuote_Direct.D07.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d07scenarioMain);

                            break;
                        case "D08":
                            Quote.CopyNewQuote_Direct.D08.ScenarioMain d08scenarioMain = new Quote.CopyNewQuote_Direct.D08.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d08scenarioMain);

                            break;

                        case "D09":
                            Quote.CopyNewQuote_Direct.D09.ScenarioMain d09scenarioMain = new Quote.CopyNewQuote_Direct.D09.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d09scenarioMain);

                            break;
                        case "D10":
                            Quote.CopyNewQuote_Direct.D10.ScenarioMain d10scenarioMain = new Quote.CopyNewQuote_Direct.D10.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d10scenarioMain);

                            break;
                        case "D11":
                            Quote.CopyNewQuote_Direct.D11_D12.ScenarioMain d11scenarioMain = new Quote.CopyNewQuote_Direct.D11_D12.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d11scenarioMain);

                            break;
                        case "D13":
                            Quote.CopyNewQuote_Direct.D13.ScenarioMain d13scenarioMain = new Quote.CopyNewQuote_Direct.D13.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
                            smartPriceMain.ExecuteTestCases(scenario.ScenarioID, scenario.TestCases, d13scenarioMain);

                            break;
                        case "D16":

                            Quote.CopyNewQuote_Direct.D16.ScenarioMain d16scenarioMain = new Quote.CopyNewQuote_Direct.D16.ScenarioMain(URLHelper.GetDSAUrl(), smartPriceMain.Driver);
