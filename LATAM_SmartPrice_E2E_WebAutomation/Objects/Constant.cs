...
namespace SmartPrice_E2E_WebAutomation.Objects
{
    public class Constant 
    {
        ...
        //    Count = 0;
        //}
        public static string URL_G4 => " https://sales-sit-g4.dell.com/#/";
        public static string URL_G2 => " https://sales-sit-g2.dell.com/#/";
        public static string URL_Prod => "https://sales.dell.com";
        ...
        public By BySearchQuoteNumber => By.Id("quoteSearch_quoteNumber");
        ...
        public By ByMoreAction => By.Id("moreActionsDropdown");
  ...
  //      public By ByProduct => By.CssSelector("#quoteCreate_LI_0_" + Count + ".k-icon.k-i-arrow-s");
        ...
        public By ByViewMore (int count)=> By.XPath("//a[@id='toggleMoreLess_0_" + count + "']/i[@class='icon-ui-collapse']");
  ...
  //      public By ByViewMoreAccessory => By.XPath("//div[@id='2_LI_NTSKU_Sku_collapsible_uStDXHdwI0acpWob6N-wiQ_0_0_"+accessoriesCount+"']/a[@class='viewMore__child__nonTied' and @id='toggleMoreLess_0_0']/i[@class='icon-ui-expand']");
        public By ByViewMoreAccessory => By.XPath("//a[starts-with(@id,'toggleMoreLess_')]/i[@class='icon-ui-expand']");
        ...
        public By BySkuNumber => By.XPath("//*[starts-with(@id,'lineitem_config_block_') and contains(@id,'_body')]/div[2]/table/tbody/tr[2]/td[3]");
        ...
        public By ByFindSkus(string prodDesc) => By.XPath("//div[text()='] Base: 'or text()='] " + prodDesc + ": ']");
        public By ByDiscountField => By.XPath("(//*[@id='quoteCreate_LI_dolPercentage_0_" + Count + "'])[2]");
        ...
        public By ByApplyChangesMenuItemObj => By.XPath("//button[@aria-controls='priceModeDropdown']/span");
        ...
        public By ByClickOnServiceModule(string test) => By.XPath("(//label[@id='productConfig_option_"+test+"']/../../../div[3]//div[@class='module-desc'])[2]");
        ...
        public By BySelectService(string serviceId) => By.XPath("(//*[text()='" + serviceId + "']/preceding-sibling::td/input[1])[2]");
        public By ByCurrentQuote => By.XPath("//*[@id='menu_currentQuote1']");
   ...
   //     public By ByConfigTable => By.XPath("//table[@class='config-option-sku-table']/tbody");
        ...
        public By ByConfigServiceListPrice(string serviceId) => By.XPath("(//*[text()='"+ serviceId + "']/../td[5])[2]");
        public By ByConfigServiceListPriceCheckBox(string serviceId) => By.XPath("(//*[text()='" + serviceId + "']/../td[4])[2]");
        public By ByConfigServiceListPriceAfterDiscount(string serviceId)=> By.XPath("(//*[text()='" + serviceId + "']/../td[5]/div/div/span[@class='greenText'])[2]");
       ...
       // public IWebElement ViewMore => WebDriver.FindElement(ByViewMore);
        ...
        public IWebElement SearchQuoteNumber => WebDriver.FindElement(BySearchQuoteNumber);
        ...
        public IWebElement DiscountField =>WebDriver.FindElement(ByDiscountField);
