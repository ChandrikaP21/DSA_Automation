...
namespace SmartPrice_E2E_WebAutomation.Quote.CreateNewQuote_Indirect.StockAndSell.D87_D88
{
    public class ScenarioMain : D78.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test,string scenarioId,int testCaseNumber)
        {
            ...
            try
            {
                ...
                d11_d12scenario.ChangeSFDCId(retriveSmartPriceData,withOutVersionQuoteNo, customerClass, test.IsSFDCIdentificationDataAutomatic, ds, test.SFDCIdentificationQuery, test.SFDCIdentificationData, totalFinancialCalculation, scenarioId, testCaseNumber);
