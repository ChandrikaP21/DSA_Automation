...
namespace SmartPrice_E2E_WebAutomation.Quote.CopyNewQuote_Indirect.D59_D60
{
    public class ScenarioMain : D49.ScenarioMain
    {
        ...
        public void ExecuteTestcases(TestCase test,string scenarioId,int testCaseNumber)
        {
            ...
            try
            {
                ...
                d11_12.ChangeSFDCId(retriveSmartPriceData,withOutVersionQuoteNo,customerClass,test.IsSFDCIdentificationDataAutomatic,ds, test.SFDCIdentificationQuery,test.SFDCIdentificationData, totalFinancialCalculation,scenarioId,testCaseNumber);
