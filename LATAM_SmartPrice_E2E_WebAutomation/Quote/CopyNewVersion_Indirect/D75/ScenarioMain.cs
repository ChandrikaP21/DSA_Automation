...
namespace SmartPrice_E2E_WebAutomation.Quote.CopyNewVersion_Indirect.D75
{
        ...
        public void ExecuteTestcases(TestCase test,int testCaseNumber)
        {
          ...
          Constant cs = new Constant(WebDriver);
            ...
            try
            {
                ...
                {
                    d13.RetriveDataFromDSAScreen(retriveSmartPriceData,totalFinancialCalculation, true, ds, cs, resultLog, testCaseNumber, test, "D75",null, null, null,isIndirect,customerObj);
